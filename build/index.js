...
var _cropperjs = __webpack_require__(15);
...
var _reactCropper = __webpack_require__(8);

var _reactCropper2 = _interopRequireDefault(_reactCropper);

var _b64ToBlob = __webpack_require__(6);
...
var ImageCropper = function (_React$Component) {
    ...
    _createClass(ImageCropper, [{
        ...
        value: function crop() {
            if (this.cropper) {
                var data = (0, _lodash.replace)(this.cropper.getCroppedCanvas().toDataURL(), 'data:image/png;base64,', '');
                this.setState({ croppedImageFile: (0, _b64ToBlob2.default)(data, 'image/png') });
                if (this.props.onCrop) this.props.onCrop((0, _b64ToBlob2.default)(data, 'image/png'));
            }
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                imagePreviewUrl && !cropper && preview && _react2.default.createElement('img', { src: imagePreviewUrl, alt: '' }),
                imagePreviewUrl && cropper && _react2.default.createElement(_reactCropper2.default, {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'span',
                        null,
                        '' + (imagePreviewUrl && (cropper || preview) ? 'Replace' : 'Upload'),
                        ' image'
                    )
                )
            );
